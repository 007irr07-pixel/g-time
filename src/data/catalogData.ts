    ...
    subcategories: [
      {
        ...
        columns: [],
        rows: [],
        note: "В текущем прайс-листе за январь 2026 года позиции по специальным фасонным профилям отсутствуют. Пожалуйста, обратитесь к вашему менеджеру для уточнения цен и наличия: +7 (708) 169 20 17",
      },
    ],
  },
